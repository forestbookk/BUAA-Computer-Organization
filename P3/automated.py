...
myfriendmem = open("foreverYoloCpu.circ", encoding="utf-8").read()
myfriendmem = re.sub(r'addr/data: 12 32([\s\S]*?)</a>', "addr/data: 12 32\n" + content + "</a>", myfriendmem)
with open("foreverYoloCpu_m.circ", "w", encoding="utf-8") as file:
...
command = "java -jar D:\BUAA\software\Logisim\logisim-generic-2.7.1.jar D:\BUAA\practice\logism\cpu_test\\foreverYoloCpu_m.circ -tty table > 另一个单周期cpu结果.txt"
os.system(command)
