...
time = 300
cpu_path = "C:\\Users\\shael\\CO\\P4\\cpu"
test_path = "C:\\Users\\shael\\CO\\P4\\test"
res_path = "C:\\Users\\shael\\CO\\P4\\test\\res"
record_path = "C:\\Users\\shael\\CO\\P4\\test\\res\\record"
log_path = "C:\\Users\\shael\\CO\\P4\\test\\res"
file_cpu = res_path + "\\myCpu.txt"
file_mars = res_path + "\\mars.txt"
addition_instr ="C:\\Users\\shael\\CO\P4\\test\\bsoal.class"

# 0.自动化生成数据
def generate():
    print("自动生成指令中")
    os.system("python "+test_path+"\\generator.py")
    return
def for_generate():
    print("自动生成指令中")
...
def AC():
    print("Mars自动生成标答中")
    os.system("java -jar "+ test_path +"\\Mars_CO_v0.4.1.jar "+record_path+"\\test.asm nc mc CompactLargeText coL1 cl "+addition_instr+" ig > " + res_path + "\\mars.txt")
    return
...
for i in range(1,test_time):
    ...
    cpu()
    os.chdir(res_path)
    compare_file(r'myCpu.txt', r'mars.txt', r'C:\\Users\\shael\\CO\\P4\\test\\res\\record\\detail_result_'+str(i)+'.html')
    os.chdir(record_path)
    file_diff_compare(file_cpu, file_mars, diff_out="C:\\Users\\shael\\CO\\P4\\test\\res\\record\\diff_result"+str(i)+".html")
