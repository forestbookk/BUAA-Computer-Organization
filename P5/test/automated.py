...
time = 1000
cpu_path = "C:\\Users\\shael\\CO\\P5\\cpu"
test_path = "C:\\Users\\shael\\CO\\P5\\test"
res_path = "C:\\Users\\shael\\CO\\P5\\test\\res"
record_path = "C:\\Users\\shael\\CO\\P5\\test\\res\\record"
log_path = "C:\\Users\\shael\\CO\\P5\\test\\res"
file_cpu = res_path + "\\myCpu.txt"
file_mars = res_path + "\\mars.txt"
addition_instr ="C:\\Users\\shael\\CO\\P5\\test\\bsoal.class"
...
for i in range(1,test_time):
    ...
    cpu()
    # os.chdir(res_path)
    # compare_file(r'myCpu.txt', r'mars.txt', r'C:\\Users\\shael\\CO\\P5\\test\\res\\record\\detail_result_'+str(i)+'.html')
    # os.chdir(record_path)
    # file_diff_compare(file_cpu, file_mars, diff_out="C:\\Users\\shael\\CO\\P5\\test\\res\\record\\diff_result"+str(i)+".html")
