...
#endif
static const char *ng0 = "D:/BUAA/practice/ise/P6-cpu/BE.v";
...
LAB76:    memcpy(t39, t77, 8);

LAB77:    goto LAB55;

LAB56:    xsi_vlog_unsigned_bit_combine(t13, 4, t28, 4, t39, 4);
    goto LAB60;

LAB58:    memcpy(t13, t28, 8);
    goto LAB60;
...
LAB79:    *((unsigned int *)t79) = 1;

LAB81:    memset(t78, 0, 8);
    t94 = (t79 + 4);
...
LAB89:    if (*((unsigned int *)t101) > 0)
        goto LAB90;

LAB91:    if (*((unsigned int *)t78) > 0)
        goto LAB92;

LAB93:    memcpy(t77, t110, 8);

LAB94:    goto LAB72;

LAB73:    xsi_vlog_unsigned_bit_combine(t39, 4, t58, 4, t77, 4);
    goto LAB77;

LAB75:    memcpy(t39, t58, 8);
    goto LAB77;
...
LAB88:    t110 = ((char*)((ng10)));
    goto LAB89;

LAB90:    xsi_vlog_unsigned_bit_combine(t77, 4, t105, 4, t110, 4);
    goto LAB94;

LAB92:    memcpy(t77, t105, 8);
    goto LAB94;
...
LAB193:    xsi_set_current_line(97, ng0);
...
extern void work_m_00000000002816754410_4140825114_init()
{
	static char *pe[] = {(void *)Cont_33_0,(void *)Always_36_1,(void *)Always_65_2};
	xsi_register_didat("work_m_00000000002816754410_4140825114", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000002816754410_4140825114.didat");
